...
## Note: expects directories called 'tokenized_random_data', 'models'
...
def load_process_data_from_hub():
    ...
    train_data.save_to_disk(f'./tokenized_random_data/train')
    test_data.save_to_disk(f'./tokenized_random_data/test')
    val_data.save_to_disk(f'./tokenized_random_data/val')
...
if __name__ == '__main__':
    ...
    train_data = load_from_disk(f'./tokenized_random_data/train')
    test_data = load_from_disk(f'./tokenized_random_data/test')
    val_data = load_from_disk(f'./tokenized_random_data/val')
